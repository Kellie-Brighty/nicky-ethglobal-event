            ...
            <div>
              ...
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  <span className="text-neon-blue/60">Calories</span>
                  <span className="text-light-gray">
                    {item.nutrition.calories} kcal
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="text-neon-blue/60">Protein</span>
                  <span className="text-light-gray">
                    {item.nutrition.protein}g
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="text-neon-blue/60">Carbs</span>
                  <span className="text-light-gray">
                    {item.nutrition.carbs}g
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="text-neon-blue/60">Fat</span>
                  <span className="text-light-gray">{item.nutrition.fat}g</span>
                </div>
              </div>
            </div>
